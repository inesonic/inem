...
#define MODEL_COMMON_H
         ...
         */
        #define MODEL_PUBLIC_API __declspec(dllexport)
         ...
         * __declspec(dllimport) on Windows.
         */
        #define MODEL_PUBLIC_API __declspec(dllimport)
     ...
     */
    #define MODEL_PUBLIC_TEMPLATE_METHOD __forceinline
     ...
     * __declspec(dllimport) on Windows.
     */
    #define MODEL_PUBLIC_API

    /**
     * Macro that circumvents limitations in the Windows DLL implementation for templated class methods.  The macro
     * expands to "__forceinline" on Windows and nothing on other platforms.
     */
    #define MODEL_PUBLIC_TEMPLATE_METHOD
