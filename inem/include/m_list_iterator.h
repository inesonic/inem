...
#ifndef M_LIST_ITERATOR_H
#define M_LIST_ITERATOR_H
...
namespace M {
    ...
    /**
     * The \ref List bidirectional iterator class.
     *
    ...
    template<typename T> class ListIterator {
        ...
        private:
             ...
             */
            ListIterator(List<T>* list, Index index) {
                currentList  = list;
                currentIndex = index;
            }
        ...
        public:
            ...
            /**
             * Method you can call to backup the iterator by a specified distance.  The default implementation works
             * by repeatedly calling \ref backup().
             *
             ...
             * \return Returns a reference to this iterator.
             */
            ListIterator& operator+=(long offset) {
                advance(offset);
                return *this;
            }
             ...
             */
            ListIterator operator+(long offset) const {
                ListIterator result = *this;
             ...
             * \return Returns a new, adjusted iterator.
             */
            long operator+(const ListIterator& other) const {
             ...
             * \return Returns a new, adjusted iterator.
             */
            long operator+(const ListConstIterator<T>& other) const {
                return currentIndex + other.currentIndex;
            }
             ...
             *         to different elements.
             */
            inline bool operator!=(const ListConstIterator<T>& other) const {
                return other.currentIndex != currentIndex;
            }
