...
* \file
*
* This file implements the \ref M::PerThread::XorShiRo256Plus class.
***********************************************************************************************************************/
...
namespace M {
    PerThread::XorShiRo256Plus::XorShiRo256Plus():PerThread::XorShiRo256Base() {}


    PerThread::XorShiRo256Plus::XorShiRo256Plus(
    ...
    unsigned long long PerThread::XorShiRo256Plus::random64() {
    ...
    void PerThread::XorShiRo256Plus::fillArray(void* array, unsigned long numberValues) {
