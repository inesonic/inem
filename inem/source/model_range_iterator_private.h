...
* \file
*
* This header defines the \ref Model::RangeIterator::Private class.
***********************************************************************************************************************/

/* .. sphinx-project inem */

#ifndef MODEL_RANGE_ITERATOR_PRIVATE_H
#define MODEL_RANGE_ITERATOR_PRIVATE_H
...
namespace Model {
    ...
    /**
     * Private implementation of the \ref Model::RangeIterator class.
     */
    class RangeIterator::Private {
        friend class Range;
        ...
        public:
             ...
             * Constructor
             *
             * \param[in] rangeImplementation The instance to be copied.
             *
             * \param[in] index               The index used to position the iterator.
             */
            Private(const Range* rangeImplementation, unsigned long long index = 0);
