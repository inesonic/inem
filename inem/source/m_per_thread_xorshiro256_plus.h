...
* \file
*
* This header defines the \ref M::PerThread::XorShiRo256Plus class.
***********************************************************************************************************************/

/* .. sphinx-project inem */

#ifndef M_PER_THREAD_XORSHIRO256_PLUS_H
#define M_PER_THREAD_XORSHIRO256_PLUS_H
...
namespace M {
     ...
     */
    class PerThread::XorShiRo256Plus:public PerThread::XorShiRo256Base {
        public:
            XorShiRo256Plus();
             ...
             */
            XorShiRo256Plus(const RngSeed& rngSeed, unsigned extra);

            ~XorShiRo256Plus() override;
